        ...
        children: [
            {
                ...
                label: 'Dashboard',
                type: "nav-item",
                icon: <GraphicEqIcon sx={{fontSize: 25}}/>
            },
            {
                uri: "/users/listing",
                label: 'Users',
                access:"user.view_user",
                type: "nav-item",
            ...
            },
            {
                uri: "/patients",
                label: 'Patients',
                access:"patients.view_patients",
                type: "nav-item",
                icon: <AccessibleIcon sx={{fontSize: 25}}/>
            },
            {
                uri: "/conference",
                label: 'Conference',
                access:"conference.view_conference",
                type: "nav-item",
                icon: <VideocamIcon sx={{fontSize: 25}}/>
            },
        ]
    },
    {
        ...
        children: [
            {
                label: 'Medicine',
                type: "collapsible",
                icon: <VaccinesIcon sx={{fontSize: 25}}/>,
                children: [
                    {
                        uri: "/medicine/category",
                        label: "Medicine Category",
                        access:"medicine.view_medicine",
                        type: "nav-item"
                    },
                    {
                        uri: "/medicine/list",
        ...
        children: [
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        access:"role.view_role",
                        type: "nav-item"                        
                    },
                    {
                        uri: "/diseases/list",
                        label: "Diseases",
                        access:"diseases.view_diseases",
                        type: "nav-item"
                    }
                ]
            }
                ...
                children: [
                    {
                        uri: "/statistics",
                        label: "Statistics",
                        access:"statastics.view_statastics",
                        type: "nav-item"
                    },
                ]
            }
